...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2025 at 01:16 PM
...
-- Add cash_received column to orders table if it doesn't exist
ALTER TABLE `orders` 
ADD COLUMN IF NOT EXISTS `cash_received` DECIMAL(10,2) NULL DEFAULT NULL AFTER `total_amount`,
ADD COLUMN IF NOT EXISTS `payment_notes` TEXT NULL DEFAULT NULL AFTER `payment_status`,
ADD COLUMN IF NOT EXISTS `payment_updated_at` TIMESTAMP NULL DEFAULT NULL AFTER `payment_notes`;
...
(1, 3, 4, 1, NULL, '2025-04-17 10:56:16', '2025-04-17 10:56:16');
...
(25, 1, 25, 'expiring_soon', 'Milk (40.00 L) will expire in 0 days', 0, NULL, NULL, '2025-04-17 04:21:13'),
(26, 1, 23, 'expiring_soon', 'Onions (20.00 kg) will expire in 6 days', 0, NULL, NULL, '2025-04-17 04:21:13');
...
(4, 1, 'Hot Beverages', 'Warm and comforting drinks perfect for chilly mornings or mid-day breaks.', '2025-04-15 06:45:41', '2025-04-15 06:45:41');
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('cash','credit','esewa') NOT NULL DEFAULT 'cash',
  `payment_status` enum('pending','paid','cancelled') NOT NULL DEFAULT 'pending',
  `cash_received` decimal(10,2) DEFAULT NULL,
  `payment_notes` text DEFAULT NULL,
  `payment_updated_at` timestamp NULL DEFAULT NULL,
  `notes` text DEFAULT NULL,
  `status` enum('pending','accepted','rejected','in_progress','ready','completed','cancelled') NOT NULL DEFAULT 'pending',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`credit_account_id`) REFERENCES `credit_accounts` (`id`),
  CONSTRAINT `orders_ibfk_4` FOREIGN KEY (`student_id`) REFERENCES `staff_students` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 1, 'uploads/qr_codes/vendor_1_67fe080cf2cb7.png', '2025-04-15 07:17:33');
...
CREATE TABLE `payment_history` (
  ...
  CONSTRAINT `payment_history_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
COMMIT;
