...
<!-- User Management -->
<li class="nav-item ' . (in_array(basename($_SERVER['PHP_SELF']), ['staff.php', 'students.php', 'workers.php']) ? 'menu-open' : '') . '">
...
<!-- Vendor Management -->
<li class="nav-item ' . (in_array(basename($_SERVER['PHP_SELF']), ['vendors.php', 'approve_vendors.php']) ? 'menu-open' : '') . '">
    <a href="#" class="nav-link">
...
<li class="nav-item ' . (in_array(basename($_SERVER['PHP_SELF']), ['transactions.php', 'financial_reports.php']) ? 'menu-open' : '') . '">
    <a href="#" class="nav-link">
...
<!-- Reports -->
<li class="nav-item ' . (in_array(basename($_SERVER['PHP_SELF']), ['user_reports.php', 'vendor_reports.php', 'order_reports.php']) ? 'menu-open' : '') . '">
    <a href="#" class="nav-link">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="../admin/order_reports.php" class="nav-link ' . (basename($_SERVER['PHP_SELF']) == 'order_reports.php' ? 'active' : '') . '">
                <i class="far fa-circle nav-icon"></i>
                <p>Order Reports</p>
            </a>
        </li>
