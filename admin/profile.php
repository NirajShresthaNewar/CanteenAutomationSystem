...
try {
    ...
    if (!$userData) {
        $_SESSION['error'] = "Administrator information not found";
        header('Location: dashboard.php');
        exit();
    }
    
    // Admin doesn't have role-specific information in other tables
    $roleSpecificData = [];
    
    // Sensitive information that can't be edited
    $readOnlyFields = ['email']; // Admins can change their username and contact info
